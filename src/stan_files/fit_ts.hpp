...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(55, 55, "end", "model_fit_ts");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n_ts; ++i) {
                ...
                stan::math::assign(get_base1_lhs(rho,i,"rho",1), (exp(get_base1(logit_rho,i,"logit_rho",1)) / (exp(get_base1(logit_rho,i,"logit_rho",1)) + 1)));
                current_statement_begin__ = 35;
                stan::math::assign(get_base1_lhs(pop,pos,"pop",1), get_base1(pop_init,i,"pop_init",1));
                current_statement_begin__ = 36;
                for (int t = (pos + 1); t <= ((pos + get_base1(n_per,n_ts,"n_per",1)) - 1); ++t) {

                    current_statement_begin__ = 38;
                    stan::math::assign(get_base1_lhs(pop,t,"pop",1), (((get_base1(beta,i,"beta",1) * get_base1(x,t,"x",1)) + (get_base1(rho,i,"rho",1) * (get_base1(pop,(t - 1),"pop",1) - (get_base1(beta,i,"beta",1) * get_base1(x,(t - 1),"x",1))))) + (sig_proc * get_base1(z_proc,(t - (i - 1)),"z_proc",1))));
                }
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            current_statement_begin__ = 26;
            validate_non_negative_index("rho", "n_ts", n_ts);
            vector<double> rho(n_ts, 0.0);
            stan::math::initialize(rho, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(rho,DUMMY_VAR__);
            current_statement_begin__ = 27;
            validate_non_negative_index("pop", "n_obs", n_obs);
            vector<double> pop(n_obs, 0.0);
            stan::math::initialize(pop, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(pop,DUMMY_VAR__);
...
typedef model_fit_ts_namespace::model_fit_ts stan_model;
